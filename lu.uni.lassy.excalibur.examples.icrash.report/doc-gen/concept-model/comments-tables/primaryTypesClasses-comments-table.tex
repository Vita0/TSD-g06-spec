...
\adddoublerow{ctComCompany}{used to model system's representation about the actors that have the responsibility to send sms messages of humans.}
\adddoubletwocolumnrow{attribute}{\msrcode{id: ptInteger}}{a unique identification information.}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aid:ptInteger):ptBoolean}}{used to initialize the current object as a new instance of the ctComCompany type.}
