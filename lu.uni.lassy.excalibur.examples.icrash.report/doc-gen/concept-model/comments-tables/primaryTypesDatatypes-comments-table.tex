...
\adddoublerow{dtFamilyPhoneNumbers}{a container used to store the family phone numbers associated with the crisis.}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{used to determine which list with family phone numbers are considered as valid. Container dtFamilyPhoneNumbers is valid if length of list with family phone numbers more than 0.}
