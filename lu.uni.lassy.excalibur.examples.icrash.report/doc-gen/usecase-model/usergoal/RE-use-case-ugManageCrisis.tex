...
\addnumberedsinglerow{}{\msrucname{oeAddFamilyMemberOnCrisis [0..*]}}
\addnumberedsinglerow{}{\msrucname{oeDeleteFamilyMemberOnCrisis [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeAddFamilyMemberOnCrisis} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeDeleteFamilyMemberOnCrisis} use case}
