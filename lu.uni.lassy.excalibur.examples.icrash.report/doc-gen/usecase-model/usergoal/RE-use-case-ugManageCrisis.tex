...
\addnumberedsinglerow{}{\msrucname{oeAddFamilyNumbersOnCrisis [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeAddFamilyNumbersOnCrisis} use case}
