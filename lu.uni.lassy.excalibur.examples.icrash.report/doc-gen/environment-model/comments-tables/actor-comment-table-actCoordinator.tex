...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeReportOnCrisis}
			{\msrcode{oeReportOnCrisis(AdtCrisisID:dtCrisisID, AdtComment:dtComment, AptCrisisSendSmsFamily:ptBoolean):ptBoolean}}}
			{sent to update the textual information available for a specific handled crisis and if necessary send it to family members.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeAddFamilyMemberOnCrisis}
			{\msrcode{oeAddFamilyMemberOnCrisis(AdtCrisisID:dtCrisisID, AdtPhoneNumber:dtPhoneNumber, AptComCompanyId:ptInteger):ptBoolean}}}
			{sent to add family member with given phone number and selected communication company to a specific handled crisis.}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeDeleteFamilyMemberOnCrisis}
			{\msrcode{oeDeleteFamilyMemberOnCrisis(AdtCrisisID:dtCrisisID, AdtPhoneNumber:dtPhoneNumber):ptBoolean}}}
			{sent to delete family member by phone number for a specific handled crisis.}
